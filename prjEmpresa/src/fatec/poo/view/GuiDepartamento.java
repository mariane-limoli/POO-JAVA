...
public class GuiDepartamento extends javax.swing.JFrame {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if ( x < cadastro.size()){
            ...
            posDepto = -1; //não loclizou o objeto Departamento no ArrayList
        }
        
        if (posDepto >= 0){//operação de alterar e excluir
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        Departamento depto = new Departamento(txtSigla.getText(),
                                              txtNome.getText());
        cadastro.add(depto);
